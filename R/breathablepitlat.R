...
#'
#' @format A tibble with 3132 rows and 8 variables
#' \describe{
...
#'   \item{depth}{The soil samples were collected at two different depths (1 m and 1.5 m) from ground level.}
...
#'   \item{num_test}{Whether the measured value is numeric; TRUE for every row.}
#' }
"breathablepitlat"
