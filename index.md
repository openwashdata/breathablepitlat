...
| site | depth | lateral | time | test | location | values | num_test |
|:----:|------:|--------:|-----:|:----:|:--------:|-------:|:--------:|
|  1   |     1 |       1 |    0 |  pH  |   P2.A   |   7.62 |   TRUE   |
|  1   |     1 |       1 |    0 |  pH  |   P2.B   |   7.62 |   TRUE   |
|  1   |     1 |       1 |    0 |  pH  |   P2.C   |   7.62 |   TRUE   |
...
| depth | double | The soil samples were collected at two different depths (1 m and 1.5 m) from ground level. |
...
| num_test | logical | Whether the measured value is numeric; TRUE for every row. |
...
![Map of India, Uttar Pradesh and Fatehpur District with the study
village on the Ganga River](reference/figures/Figure1.png)

Map of India, Uttar Pradesh and Fatehpur District with the study village
on the Ganga River
